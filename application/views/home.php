	...
	<body onscroll="functionMenu()">
		...
		<div id="mcode" class="item1">
			<div class="row">
				...
				<div class="col-md-8">
					<h2><span id="bold">MOBILE CODE</span></h2>
				  	<h4>
			...
			<div id="codigos" class="row">
				...
				<div class="col-md-3">
					<h3><span id="bold">CODIGO EAN</span></h3>
				...
				<div class="col-md-3">
					<h3><span id="bold">QR CODE</span></h3>
		...
		<div id="vantagens" class="item3">
			...
			<div class="row">
			  <div class="col-md-4" style="margin-top: 50px;">
			  	<h5><span id="bold">ACOMPANHE TODO CICLO MATERIAL DE MERCHAN</span></h5>
			  ...
			  <div class="col-md-4" style="margin-top: 50px;">
			  	<h5><span id="bold">CONTROLE PONTOS DE VENDA</span></h5>
			  ...
			  <div class="col-md-4" style="margin-top: 50px;">
			  	<h5><span id="bold">CONTROLE DE EQUIPE</span></h5>
			...
			<div class="row">
			  <div class="col-md-4" style="margin-top: 50px;">
			  	<h5><span id="bold">DADOS DE CONTROLE</span></h5>
			  ...
			  <div class="col-md-4" style="margin-top: 50px;">
			  	<h5><span id="bold">DASHBOARDS CUSTOMIZADOS</span></h5>
			  ...
			  <div class="col-md-4" style="margin-top: 50px;">
			  	<h5><span id="bold">TEMPO DE VIDA ÚTIL</span></h5>
		...
		<div id="controla" class="item4">
			<div id="textoControlar">
				<h2 style="background-color: black; color:white;border-radius:20px; padding-left:10px;">
					<span id="bold">O QUE CONTROLAR COM m-code: </span>
				</h2>
			</div>
			<div class="row">
				<div class="col-md-4">
		...
		<div id="clientes" class="item5">
			<h2><span id="bold">QUEM USA M-CODE?</span></h2>
			<center>
				<div class="row">
					<div class="col-md-6">
		...
		<div id="empresa" class="item6">
			<h2><span id="bold">M-CODE</span></h2>
			<div class="row">
				<div class="col-md-10">
					...
					<h3><span id="bold">VENHA TOMAR UM CAFÉ CONOSCO E SURPREENDA-SE!</span></h3>
				</div>
				<div class="col-md-2">
		...
		<div id="fale" class="item7">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="row">
						<div class="col-md-3"><h3><span id="bold"><small>FALE</small> <p>CONOSCO</p></span></h3></div>
		...
		<div id="contato" class="item8">
			<div class="row">
				...
				<div class="col-md-3">
					<h3><span id="bold">MATRIZ:</span></h3>
					<h4>
